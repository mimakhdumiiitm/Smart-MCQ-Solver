# model.py
"""
All model logic: attention + encoder + MCQBiLSTM
"""
...
class _BiLSTMEncoder(nn.Module):
    ...
    def forward(self, x, lengths):
        ...
        packed      = pack_padded_sequence(emb, lengths.clamp(min=1).cpu(),
...
class MCQBiLSTM(nn.Module):
    """Public API — everything else above is private to this file."""
