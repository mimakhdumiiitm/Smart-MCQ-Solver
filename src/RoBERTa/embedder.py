...
"""
SBERT embedder — identical to DeBERTa version, reused as-is.
Placed here for module isolation.
"""
...
class SBERTEmbedder:
    ...
    normalize   : if True, L2-normalise so dot == cosine
    """
    ...
    def encode(self, texts: List[str]) -> np.ndarray:
        ...
        Returns
        ───────
        float32 matrix [N, dim], L2-normalised if normalize=True.
        """
